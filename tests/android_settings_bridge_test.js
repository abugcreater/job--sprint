...
assert.match(scheduleHtml, /导入画像 -> 生成个人日历/);
assert.match(androidScheduleHtml, /导入画像 -> 生成个人日历/);
assert.doesNotMatch(scheduleHtml, /data\/schedule\.json|当前任务|高级 Java/);
assert.doesNotMatch(androidScheduleHtml, /data\/schedule\.json|当前任务|高级 Java/);
assert.match(scheduleHtml, /\.\/react\/index\.html#\/today/);
assert.match(androidScheduleHtml, /\.\.\/react\/index\.html#\/today/);
assert.match(scheduleJs, /function reactTodayPath/);
assert.match(scheduleJs, /\.\/react\/index\.html#\/today/);
assert.match(scheduleJs, /\.\.\/react\/index\.html#\/today/);
assert.match(scheduleJs, /window\.location\.replace\(reactTodayPath\(window\.location\)\)/);
assert.match(scheduleJs, /等待导入画像/);
assert.match(scheduleJs, /allowedNavItems/);
assert.doesNotMatch(scheduleJs, /androidSessionCookieBridge|AndroidSessionCookies|clearAndroidSessionBtn|reopenAndroidLoginBtn/);
assert.doesNotMatch(scheduleHtml, /clearAndroidSessionBtn|reopenAndroidLoginBtn|清除 Basic Auth|当前任务|高级 Java/);
assert.doesNotMatch(androidScheduleHtml, /clearAndroidSessionBtn|reopenAndroidLoginBtn|清除 Basic Auth|当前任务|高级 Java/);
