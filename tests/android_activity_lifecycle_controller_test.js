...
assert.match(controller, /boolean onActivityResult\(int requestCode, int resultCode, Intent data\)/);
assert.match(controller, /fileChooserController\.onActivityResult\(requestCode, resultCode, data\)/);
